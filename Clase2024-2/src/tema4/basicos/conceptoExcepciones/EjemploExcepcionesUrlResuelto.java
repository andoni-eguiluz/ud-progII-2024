...
public class EjemploExcepcionesUrlResuelto {
	...
	throws ConnectException, MalformedURLException, UnknownHostException, FileNotFoundException, IOException
	{
		...
		try {
			...
			for (String equipo : equipos) {
				try {
					...
					System.out.println( "Del equipo " + equipo + " no se ha encontrado ciudad." );
				}
			}
		} catch (ConnectException | MalformedURLException | UnknownHostException | FileNotFoundException e) {
			System.out.println( "No han podido localizarse los equipos por problemas en el host." );
		} catch (IOException e) {
			System.out.println( "No han podido localizarse los equipos por otros problemas." );
		}
	}
	...
	private static void visualizaEquipo( String equipo ) throws IOException {
	...
	private static int getGradosDeCiudad( String ciudad ) throws IOException {
